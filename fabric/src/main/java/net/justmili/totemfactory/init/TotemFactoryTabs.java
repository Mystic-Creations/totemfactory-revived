...
public class TotemFactoryTabs {
	public static ResourceKey<CreativeModeTab> TAB_TOTEM_FACTORY = ResourceKey.create(Registries.CREATIVE_MODE_TAB, new ResourceLocation(TotemFactory.MODID, "totem_factory"));
